...
import com.boram.service.ReplyService;
...
public class ReplyController {
	...
	//ResponseEntity => 상태 코드값 같이 반환 (사용하지 않아도ok) produces = json 타입으로 전송(application.json.value)
	...
	public ResponseEntity<ReplyPageDTO> getList(@PathVariable("bno") Long bno, @PathVariable("page") int page){
		...
		System.out.println(service.getListPage(cri, bno).getReplyCnt());
	...
	//수정 requestbody로 전체vo 데이터를 json타입으로 받아옴, consumes로 json타입 명시
